...
2. From the UI
3. From External Sources - Data fetched from Web API (Application Program Interface)
...
- Use when high-performance is important (searching inside array is faster)
...
- Easier to write access values with . and []
